...
export default function Vindicator() {
    const skillText = {
        ...
        "react": "React — Empowers Vindicator to protect his allies with lightning-fast responses and unmatched adaptability. Dynamically adjusts his tactics to counter any adversary",
